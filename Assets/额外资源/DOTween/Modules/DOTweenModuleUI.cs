...
namespace DG.Tweening
{
	public static class DOTweenModuleUI
    {
        ...
        /// <param name="scrambleMode">The fireType of scramble mode to use, if any</param>
        /// <param name="scrambleChars">A string containing the characterButton to use for scrambling.
        /// Use as many characterButton as possible (minimum 10) because DOTween uses a fast scramble mode which gives better results with more characterButton.
